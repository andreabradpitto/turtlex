...
register(
        id='MyTurtlexMaze-v0',
        entry_point='my_turtlex_maze:MyTurtlexMazeEnv',
        max_episode_steps=timestep_limit_per_episode,
    )

class MyTurtlexMazeEnv(turtlex_env.TurtlexEnv):
    def __init__(self):
        """
        ...
        self.number_of_sectors = rospy.get_param('/turtlex/number_of_sectors')
        self.min_range = rospy.get_param('/turtlex/min_range')
        self.middle_range = rospy.get_param('/turtlex/middle_range')
        
        self.danger_laser_value = rospy.get_param('/turtlex/danger_laser_value')
        self.middle_laser_value = rospy.get_param('/turtlex/middle_laser_value')
        self.safe_laser_value = rospy.get_param('/turtlex/safe_laser_value')
        ...
        super(MyTurtlexMazeEnv, self).__init__()
