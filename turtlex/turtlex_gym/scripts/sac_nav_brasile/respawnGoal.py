...
class Respawn():
    ...
    def getPosition(self, position_check=False, delete=False):
        ...
        if self.stage != 4:
            while position_check: # TODO ANDREA: questo e un while per generare delle x,y casuali come goal, pero poi viene controllato che il goal non
                # sia troppo vicino agli ostacoli della mappa (conosciuti da chi programma, ma direi di no dal robot). Se il goal generato non va bene
                # o se e troppo vicino a quello precedente, genera subito un nuovo goal
        ...
        else: # TODO ANDREA: questo fa lo stesso di quello sopra, solo che la lista di goal sono prefissati. Potrei usare la stessa idea per
            # far pulire al robot
