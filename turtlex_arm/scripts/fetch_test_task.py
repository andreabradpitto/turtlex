...
import fetch_env #from openai_ros.robot_envs import fetch_env


register(
        id='FetchTest-v0',
        entry_point='fetch_test_task:FetchTestEnv',
...
class FetchTestEnv(fetch_env.FetchEnv, utils.EzPickle):
    ...
    def get_params(self):
        ...
        self.impossible_movement_punishment = rospy.get_param('/fetch/impossible_movement_punishment')
