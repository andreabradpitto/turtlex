...
import fetch_test_task #from openai_ros.task_envs.fetch import fetch_test_task
...
class DQNRobotSolver():
    ...
    def run(self, num_episodes, do_train=False):
        ...
        for ep in range(num_episodes):
            ...
            #if monitor: self.env.stats_recorder.done = None # TODO
...
if __name__ == '__main__':
    ...
    rospy.init_node('fetch_n1try_algorithm', anonymous=True, log_level=rospy.INFO)
    ...
    n_episodes_testing = rospy.get_param('/fetch/episodes_testing')
